            ...
            <div className="sm:h-[600px] sm:w-[800px] h-full w-full relative">
                ...
                <div className="absolute  sm:top-14 top-5 m-2 sm:m-0  sm:left-32 sm:bg-white/80 flex  border-t-2 border-l-2 border-gray-500 border-b-2 border-r-2 border-b-gray-200 border-r-gray-200 bg-white  p-2"> 
                   <ul>
                    ...
                    <li className="text-lg sm:text-2xl">Systems and Computer Engineering </li> 
                     <li>Continental University (<span className="italic mr-2">2021 - 2026 </span>)</li>
                     <li className="hidden sm:block" >-----------------------------------------------------</li>
                    <li className="text-lg sm:text-2xl">Graphic Design for Advertising </li> 
                    <li>Institute of Design and Communication (IDC) (<span className="italic sm:mr-2"> 2012 - 2016</span>)</li>
                    <li className="hidden sm:block">-----------------------------------------------------</li>
                    </ul>
                </div>
                <a
