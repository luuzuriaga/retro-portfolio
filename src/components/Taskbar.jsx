    ...
    <>
      ...
      {showMenu && (
        <div className="absolute bottom-12 left-0 w-48 border-t border-l border-white border-b-2 border-r-2 border-b-gray-700 border-r-gray-700 bg-gray-100 shadow-md z-50">
          ...
          <div
            ...
            className="px-3 py-2 hover:bg-blue-600 border-b-2 border-gray-300 hover:text-white cursor-pointer"
          >
            <img src={ArtIcon} alt="Art" className="inline-block w-4 h-4 mr-2" /> UX/UI.exe
          </div>
          <div
            onClick={() => {
              onAppClick("connect");
      ...
      <div className="fixed bottom-0 font-bold left-0 right-0 border-t border-l border-white border-b-2 border-r-2 border-b-gray-500 border-r-gray-500 bg-gray-200 shadow-md text-black text-sm sm:text-2xl p-1 flex items-center z-40">
        ...
        <div className="ml-auto flex leading-sm flex-row px-4 text-sm gap-2 sm:text-2xl">
           <a href="mailto:lucero.uzuriaga20200@gmail.com" target="_blank"><img src={MailIcon} className= "hover:scale-110 w-4 h-4 sm:w-8 sm:h-8 cursor-pointer" ></img></a>
          <a href="https://github.com/luuzuriaga" target="_blank"><img src={Github} className= "hover:scale-110 w-4 h-4 sm:w-8 sm:h-8  cursor-pointer"></img></a>
          <a href="https://www.linkedin.com/in/lucerouzuriaga/" target="_blank"><img src={LinkedIn} className= "hover:scale-110 w-4 h-4 sm:w-8 sm:h-8 cursor-pointer" ></img></a>
